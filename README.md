...
![Profile Views](https://komarev.com/ghpvc/?username=anditisyou&color=00C7B7&style=for-the-badge&label=VISITORS)
...
```python
vaishnavi = {
    "focus":    ["Data Analytics & BI", "Machine Learning", "Full-Stack"],
    "stack":    ["Python", "SQL", "React", "Node.js", "Redis"],
    "research": "efficient DL — pruning, quantization, cheap inference",
    "offline":  "out shooting photography",
}
```
...
<details>
<summary><b>🤖 &nbsp;Chatbot Platform DSL</b> — a language that compiles into a bot</summary>
...
<details>
<summary><b>📊 &nbsp;AI-Enabled Business Intelligence</b> — raw tables → executive dashboards</summary>
...
<details>
<summary><b>🔬 &nbsp;Research in progress</b></summary>
...
![Tableau](https://img.shields.io/badge/Tableau-E97627?style=for-the-badge&logo=tableau&logoColor=white&labelColor=0D1117)
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:7B2FF7,50:00C7B7,100:0D1117&height=120&section=footer" width="100%" />
